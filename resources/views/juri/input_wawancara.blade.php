    ...
    <main class="p-6 text-gray-800">
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <div>
                ...
                <h2 class="text-base font-semibold text-gray-900 leading-tight">Input Nilai Wawancara</h2>
                <p class="text-xs text-gray-500 mt-0.5">Berikan penilaian wawancara untuk peserta.</p>
            </div>
        </div>
        ...
        <form action="{{ route('penilaian.store') }}" method="POST" class="space-y-5">
            @csrf
            <input type="hidden" name="kategori" value="wawancara">
            ...
            <div class="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
                ...
                <div class="relative">
                    <select name="peserta_id" id="peserta_id" required
                        class="block w-full px-4 py-2.5 bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition appearance-none">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    {{-- Public Speaking --}}
                    <div class="bg-white border border-gray-200 rounded-xl p-5 border-l-4 border-l-indigo-500 shadow-sm">
                        ...
                        <input type="range" name="public_speaking" id="public_speaking" min="0" max="100"
                            value="0" class="w-full accent-indigo-600"
